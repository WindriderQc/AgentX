...
Operational documentation covering deployment, CI/CD, benchmarking, and system administration.
...
- [CRITICAL_GOTCHAS](./CRITICAL_GOTCHAS.md)
- [DEPLOYMENT](./DEPLOYMENT.md)
- [DEPLOYMENT_READINESS_CHECKLIST](./DEPLOYMENT_READINESS_CHECKLIST.md)
- [DIMENSION_ARCHITECTURE](./DIMENSION_ARCHITECTURE.md)
- [ENHANCED_JUDGING_SYSTEM_PLAN](./ENHANCED_JUDGING_SYSTEM_PLAN.md)
- [GENERALIST_SCORING_SYSTEM](./GENERALIST_SCORING_SYSTEM.md)
- [NOTIFICATION_CHANNELS](./NOTIFICATION_CHANNELS.md)
...
- [Architecture](./metrics-cleanup/ARCHITECTURE.md) - Service architecture and data flow
