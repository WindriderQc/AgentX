...
**Location:** Historical workflow templates are described here conceptually; current checked-in workflow exports live under `n8n_workflows/`.
...
1. **Existing Workflows** (`n8n_workflows/*.json`)
   - Ingested into AgentX RAG system
   - Searchable by pattern/feature/node type

2. **Workflow Templates** (`n8n_workflows/` plus persona and script conventions in this repo)
...
- [AgentX API](../api/API.md)
- [Deployment Scripts](../../scripts/)
- [Workflow Exports](../../n8n_workflows/)
