...
export let judgeHostRecommendations = {}; // hostUrl → recommendation payload
...
export function setJudgeHostRecommendations(recommendations) { judgeHostRecommendations = recommendations; }
