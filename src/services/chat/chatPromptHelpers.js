/**
 * Chat Prompt Helpers
 * System prompt assembly, active prompt resolution, and thinking model detection
 */
...
// Get active prompt config for a persona (with workspace scoping)
...
module.exports = { isThinkingModel, getActivePrompt, buildSystemPrompt };
