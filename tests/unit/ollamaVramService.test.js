...
describe('parseHostVramMap', () => {
  ...
  it('should parse valid host=vram entries', () => {
    process.env.OLLAMA_HOST_VRAM_MAP = '192.168.2.12=14336,192.168.2.66=24576';
    const map = parseHostVramMap();
    expect(map.get('192.168.2.12')).toBe(14336);
    expect(map.get('192.168.2.66')).toBe(24576);
  ...
  it('should skip invalid entries', () => {
    process.env.OLLAMA_HOST_VRAM_MAP = '192.168.2.12=14336,bad,=100,host=-5';
    const map = parseHostVramMap();
